...
INSERT INTO PAYMENTMETHOD (SELECT 1,'cash' WHERE NOT EXISTS(SELECT * FROM PAYMENTMETHOD));
INSERT INTO PAYMENTMETHOD (SELECT 1,'pcs' WHERE NOT EXISTS(SELECT * FROM UNITTYPE));